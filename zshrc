...
# Example aliases
 ...
 alias cursor="cd /usr/share/icons/default && echo 'Edit the index.theme file here' && find /usr/share/icons ~/.local/share/icons ~/.icons -type d -name 'cursors' >> /usr/share/icons/default/index.theme "
...
zstyle :compinstall filename '/home/zim/.zshrc'
