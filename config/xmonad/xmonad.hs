...
scratchpads = [
    ...
    NS "scratch" "alacritty -t scratch -e nvim ~/.scratch.md ~/.todo.md ~/.ideas.md"
    (title =? "scratch") (customFloating $ W.RationalRect (2/6) (1/9) (2/5) (2/4)) ,

    NS "tags" "alacritty -t tags -e tags"
    (title =? "tags") (customFloating $ W.RationalRect (2/5) (3/9) (2/7) (1/5)) ,
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- , ((modm,               xK_m     ), windows R.toggleFocus  )
